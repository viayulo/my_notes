...
+ .cpp
  ...
  #+begin_src cpp
    ...
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(MYTAG, "MyTag", "Comment here.")
  #+end_src
...
+ Function support (Base on blueprint), and can be *called in editor* using button (e.g. check button)
